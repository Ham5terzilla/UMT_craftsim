...
tin_casing = tm.MetalCasingTransformation().transform(tin_frame, tin_bolts, tin_plate)
...
painite_stage1_processed = (ItemBuilder(painite)
                            .add_transformation_single(ts.PolisherTransformation())
                            .add_transformation_single(ts.GemCutterTransformation())
                            .execute())
painite_prismatic = tm.PrismaticGemCrucibleTransformation().transform(painite_stage1_processed, painite_stage1_processed)
